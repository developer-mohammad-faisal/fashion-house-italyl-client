            ...
            <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
              <div className="max-w-[570px] mb-12 lg:mb-0">
                ...
                <p className="text-base text-body-color leading-relaxed mb-9">
                  ...
                  relevant search results, Click here and Find. All the Answers. Discover us now! Multiple sources combined. Easy Acces To
                  Information.
                </p>
                <div className="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">Dhaka, Bangladesh</p>
                  </div>
                </div>
                <div className="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base font-sans text-body-color">(+880)19 988 39126</p>
                  </div>
                </div>
                <div className="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">fasion.house.italy@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
