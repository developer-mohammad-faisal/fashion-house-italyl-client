  ...
  return (
    <Fragment>
      <section>
        ...
        <div className="navbar bg-info px-5 my-3 py-6 lg:px-10">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              >
                <select defaultValue="All Categories" className="select">
          ...
          <div className="navbar-end mt-16 lg:mt-0 gap-x-4">
            ...
            <div className="indicator text-4xl flex items-center">
