        ...
        <div className="flex flex-col items-center xl:flex-row">
          ...
          <div className="flex-1 flex flex-col items-start text-start space-y-1">
            ...
            <div className="flex item-center space-x-4 py-4">
              ...
              <button onClick={() => navigate(`/cart1/${match.id}`)} className="text-white px-5 py-3 bg-stone-900 border-none rounded-none font-normal transform duration-500 hover:bg-primary">
                Buy it Now
              </button>
            </div>
