...
const Cart2 = () => {
  ...
  const [total, setTotal] = useState(handbagCart.price);
  ...
  const handleIncrement = () => {
    ...
    if (increment) {
      let increaseTotal = handbagCart.price * increment;
  ...
  const handleDecrement = () => {
    if (increment > 1) {
      ...
      let decreaseTotal = parseInt(total - handbagCart.price);
        ...
        <div class="overflow-x-auto ">
          <table class="table w-full text-center">
            ...
            <tbody>
              <tr>
                <td>
                    <img src={handbagCart.img1} className="w-16" alt="" />
                </td>
                <td>{handbagCart.name}</td>
                <td>${handbagCart.price}</td>
                <td>
