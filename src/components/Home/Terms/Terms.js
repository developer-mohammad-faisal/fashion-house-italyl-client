  ...
  return (
    <div>
      ...
      <div className="container mt-5">
        <h1 className="text-4xl font-sans"> Terms of service</h1>
        <h1 className="mt-10 text-1xl font-bold">OVERVIEW</h1>
        <p>
          This website is operated by Shoping Mall In USA. Throughout the site,
          the terms “we”, “us” and “our” refer to Shoping Mall In USA. Shoping
          Mall In USA offers this website, including all information, tools and
        ...
        <h1 className="mt-10 text-1xl font-bold font-sans">
        ...
        <p>
          ...
          minor dependents to use this site. breach or violation of any of the
        ...
        Prices for our products are subject to change without notice. <br /> We
        ...
        <p>
          ...
          case shall Shoping Mall In USA, our directors, officers, employees,
        ...
        <p>
          You agree to indemnify, defend and hold harmless Shoping Mall In USA
      ...
      <p>
        ...
        <b>fasion.house.italy@gmail.com</b>.
      </p>
      </div>
    </div>
  );
