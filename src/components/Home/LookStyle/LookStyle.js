...
const LookStyle = () => {
  return (
    <section className="h-[128px] md:h-[333px] mt-10">
      <div style={{ backgroundImage: `url(${lookstyle})` }} className="bg-no-repeat bg-contain lg:bg-cover bg-center w-full   h-full">
        <div className="flex h-full">
          <div className="w-1/2 "></div>
          <div className="pl-5 md:pl-20 w-1/2   flex items-start  justify-center h-[100%] flex-col ">
            <h1 className=" text-[15px] md:text-2xl font-semibold text-white italic">New</h1>
            ...
            <p className="text-white hidden md:block pr-5">Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras.</p>
